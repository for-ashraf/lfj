...
<head>
    ...
    <noscript>
        <iframe src="https://www.googletagmanager.com/ns.html?id=GTM-MS4Z5WJ7" height="0" width="0"
        ...
        <div class="row gx-0">
            ...
            <div class="col-lg-4 text-center text-lg-end">
                <div class="d-inline-flex align-items-center" style="height: 45px;">
                    ...
                    <a class="btn btn-sm btn-outline-light btn-sm-square rounded-circle me-2"
                        href="https://www.instagram/"><i class="fab fa-instagram fw-normal"></i></a>
                    ...
                    <ul class="navbar-nav">
                        ...
                        <li class="nav-item dropdown menu-title">
                            ...
                            <ul class="dropdown-menu" aria-labelledby="blogsDropdown">
                                ...
                                <li><a class="dropdown-item" href="/blogs/DIY Jewelry Projects">DIY Jewelry
                                        Projects</a>
                                </li>
                                <li><a class="dropdown-item" href="/blogs/Jewelry Gift Ideas">Jewelry Gift Ideas</a>
                                </li>
                            </ul>
                        </li>
                        <li class="nav-item dropdown menu-title">
                            ...
                            <ul class="dropdown-menu" aria-labelledby="eventsDropdown">
                                ...
                                <li><a class="dropdown-item" href="/events/Jewelry Exhibition">Jewelry Exhibition</a>
                                </li>
                                ...
                                <li><a class="dropdown-item" href="/events/Jewelry Launch Events">Jewelry Launch
                                        Events</a>
                                </li>
                        ...
                        <li class="nav-item dropdown menu-title">
                            ...
                            <ul class="dropdown-menu" aria-labelledby="celebritiesDropdown">
                                ...
                                <li><a class="dropdown-item"
                                        ...
                                        and
                                        Fashion Icons</a></li>
                                <li><a class="dropdown-item" href="/celebrities/Red Carpet Jewelry Moments">Red Carpet
                                        Jewelry
                                        Moments</a></li>
