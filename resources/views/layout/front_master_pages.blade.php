...
<body>
        ...
        <div class="row gx-0">
            <div class="col-lg-8 text-center text-lg-start mb-2 mb-lg-0">
                <div class="d-inline-flex align-items-center" style="height: 45px;">
                    <small class="me-3 text-light">Latest Fashion Jewellery</small>
                    <small class="text-light"><i class="fa fa-envelope-open me-2"></i>info@latestfashionjewellery.com</small>
                </div>
            </div>
    ...
    <div class="container-fluid position-relative p-0">
        ...
        <div class="container-fluid bg-primary py-5 bg-header2" style="margin-bottom: 90px; background-image: url('{{asset('images/home/3.jpg') }}');">
            <div class="row py-5">
