...
<body class="font-opensans">
    ...
    <div id="main_content">
        ...
        <div id="header_top" class="header_top">
            <div class="container">
                <div class="hleft">
                    ...
                    <div class="dropdown">
                        <a href="page-search.html" class="nav-link icon"><i class="fa fa-search" data-toggle="tooltip"
                                data-placement="right" title="Search..."></i></a>
                        <a href="javascript:void(0)" class="nav-link icon create_page xs-hide"><i class="fa fa-plus"
                                data-toggle="tooltip" data-placement="right" title="Create New"></i></a>
                        <a href="app-email.html" class="nav-link icon app_inbox"><i class="fa fa-envelope"
                                data-toggle="tooltip" data-placement="right" title="Inbox"></i></a>
                        <a href="app-filemanager.html" class="nav-link icon app_file xs-hide"><i class="fa fa-folder"
                                data-toggle="tooltip" data-placement="right" title="File Manager"></i></a>
                        <a href="app-social.html" class="nav-link icon xs-hide"><i class="fa fa-share-alt"
                                data-toggle="tooltip" data-placement="right" title="Social Media"></i></a>
                        <a href="javascript:void(0)" class="nav-link icon xs-hide"><i class="fa fa-bullhorn"
                                data-toggle="tooltip" data-placement="right" title="Projects"></i></a>
                        <a href="javascript:void(0)" class="nav-link icon xs-hide"><i class="fa fa-cloud-upload"
                                data-toggle="tooltip" data-placement="right" title="Cloud Upload"></i></a>
                    </div>
                </div>
                <div class="hright">
                    <div class="dropdown">
                        ...
                        <a href="javascript:void(0)" class="nav-link user_btn"><img class="avatar"
                                src="{{ asset('/images/user.png') }}" alt="" data-toggle="tooltip"
                ...
                <div class="card-body">
                    <ul class="list-group list-unstyled">
                        <li class="list-group-item mb-2">
                            <p>Default Theme</p>
                            <a href="light/index.html"><img src="{{ asset('/images/themes/default.png') }}"
                                    alt="" class="img-fluid" /></a>
                        </li>
                        <li class="list-group-item mb-2">
                            <p>Night Mode Theme</p>
                            <a href="dark/index.html"><img src="{{ asset('/images/themes/dark.png') }}"
                                    alt="" class="img-fluid" /></a>
                        </li>
                        <li class="list-group-item mb-2">
                            <p>Horizontal Version</p>
                            <a href="horizontal/index.html"><img src="{{ asset('/images/themes/horizontal.png') }}"
                                    alt="" class="img-fluid" /></a>
                        </li>
                        <li class="list-group-item mb-2">
                            <p>RTL Version</p>
                            <a href="rtl/index.html"><img src="{{ asset('/images/themes/rtl.png') }}" alt=""
                                    class="img-fluid" /></a>
                        </li>
                        <li class="list-group-item mb-2">
                            <p>Theme two colors</p>
                            <a href="theme1/index.html"><img src="{{ asset('/images/themes/theme1.png') }}"
                                    alt="" class="img-fluid" /></a>
                        </li>
                        <li class="list-group-item mb-2">
                            <p>Theme2 with Crypto Dashboard</p>
                            <a href="theme2/index.html"><img src="{{ asset('/images/themes/theme2.png') }}"
                                    alt="" class="img-fluid" /></a>
                        </li>
                    </ul>
                </div>
        ...
        <div class="user_div">
            <h5 class="brand-name mb-4">Crush On<a href="javascript:void(0)" class="user_btn"><i
                        class="icon-logout"></i></a></h5>
            <div class="card">
                <div class="card-body">
                    <div class="media">
                        <img class="avatar avatar-xl mr-3" src="{{ asset('/images/sm/avatar1.jpg') }}"
                            alt="avatar">
                    ...
                    <ul class="right_chat list-unstyled">
                        <li class="online">
                            <a href="javascript:void(0);">
                                <div class="media">
                                    <img class="media-object " src="{{ asset('/images/xs/avatar4.jpg') }}"
                                        alt="">
                                    <div class="media-body">
                        ...
                        <li class="online">
                            <a href="javascript:void(0);">
                                <div class="media">
                                    <img class="media-object " src="{{ asset('/images/xs/avatar5.jpg') }}"
                                        alt="">
                                    <div class="media-body">
                        ...
                        <li class="offline">
                            <a href="javascript:void(0);">
                                <div class="media">
                                    <img class="media-object " src="{{ asset('/images/xs/avatar2.jpg') }}"
                                        alt="">
                                    <div class="media-body">
        ...
        <div id="left-sidebar" class="sidebar ">
            ...
            <nav id="left-sidebar-nav" class="sidebar-nav">
                <ul class="metismenu">
                    ...
                    <li class="{{ request()->is('blogs') ? 'active' : '' }}"><a href="blogs"><i
                                class="icon-globe"></i><span>Blog</span></a></li>
                    <li>
                                ...
                                <div class="dropdown d-flex">
                                    ...
                                    <div class="dropdown-menu dropdown-menu-right dropdown-menu-arrow">
                                        ...
                                        <a class="dropdown-item"
                                            href="{{ route('users.show', auth()->user()->id) }}"><i
