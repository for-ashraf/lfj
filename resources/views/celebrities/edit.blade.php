...
{!! Form::model($celebrity, ['route' => ['celebrities.update', $celebrity->celebrity_id], 'method' => 'patch', 'enctype' => 'multipart/form-data']) !!}
                ...
                <div class="card">
                    <div class="card-body">
                        ...
                        <div class="row">
                            <div class="col-md-6">
                                <div class="form-group">
                                    ...
                                    <input type="text" class="form-control" name="name" value="{{ $celebrity->name }}" placeholder="Enter Celebrity Name...">
                                    @error('name')
                                ...
                                <div class="form-group">
                                    ...
                                    <select class="form-control" name="nationality">
                                        ...
                                        @foreach (getCountriesList() as $country)
                                            <option value="{{ $country }}" {{ $country == $celebrity->nationality ? 'selected' : '' }}>{{ $country }}</option>
                                        @endforeach
                                    </select>
                                    @error('nationality')
                        ...
                        <div class="form-group">
                            ...
                            <input type="date" class="form-control" name="birthdate" value="{{ $celebrity->birthdate }}">
                            @error('birthdate')
                                <span style="color: red;">{{ $message }}</span>
                            @enderror
                        </div>
                            ...
                            <div class="col-md-6">
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="input-group">
                                        ...
                                        <input type="text" class="form-control" name="instagram" value="{{ $celebrity->instagram }}" placeholder="Enter Instagram URL...">
                                    </div>
                                </div>
                            </div>
                            <div class="col-md-6">
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="input-group">
                                        ...
                                        <input type="text" class="form-control" name="twitter" value="{{ $celebrity->twitter }}" placeholder="Enter Twitter URL...">
                                    </div>
                                </div>
                            </div>
                        </div>
                            ...
                            <div class="col-md-6">
                                <div class="form-group">
                                    ...
                                    <div class="input-group">
                                        ...
                                        <input type="text" class="form-control" name="facebook" value="{{ $celebrity->facebook }}" placeholder="Enter Facebook URL...">
                                    </div>
                                </div>
                            </div>
                            <div class="col-md-6">   
                                <div class="form-group">
                                    ...
                                    <div class="input-group">
                                        ...
                                        <input type="text" class="form-control" name="youtube" value="{{ $celebrity->youtube }}" placeholder="Enter YouTube URL...">
                                    </div>
                                </div>
                            </div>
                        </div>
                            ...
                            <div class="col-md-6">
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="input-group">
                                        ...
                                        <input type="text" class="form-control" name="tiktok" value="{{ $celebrity->tiktok }}" placeholder="Enter TikTok URL...">
                                    </div>
                                </div>
                            </div>
                            <div class="col-md-6">
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="input-group">
                                        ...
                                        <input type="text" class="form-control" name="snapchat" value="{{ $celebrity->snapchat }}" placeholder="Enter Snapchat Handler...">
                                    </div>
                                </div>
                            </div>
                        ...
                        <div class="form-group">
                            ...
                            <div class="input-group">
                                ...
                                <input type="text" class="form-control" name="website" value="{{ $celebrity->website }}" placeholder="Enter Website URL...">
                            </div>
                        </div>
                            </div>
