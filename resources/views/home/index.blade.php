                    ...
                    <div class="bg-light shadow d-flex align-items-center justify-content-center p-4"
                        ...
                        <a href="{{ route('products') }}">
                            <div class="ps-4">
                                ...
                                <h2 class="mb-0" data-toggle="counter-up">{{ $products }}</h2>
                            </div>
                        </a>
                    </div>
                </div>
    ...
    <div class="container-fluid py-5 wow fadeInUp" data-wow-delay="0.1s">
        <div class="container py-5">
            <div class="section-title text-center position-relative pb-3 mb-5 mx-auto" style="max-width: 600px;">
                ...
                <h2 class="mb-0">Try Our Jewellery Studio-Wear the Jewellery <span style="color:pink">You</span> Love</h2>
            </div>
                    ...
                    <div class="col-lg-4  wow zoomIn" data-wow-delay="0.9s" style="min-height: 350px;">
                        <div class="position-relative h-100">
                            <img class="position-absolute w-100 h-100 rounded wow zoomIn" data-wow-delay="0.1s"
                                src="{{ asset('uploads/home/jewellery_studio.jpg') }}" style="object-fit: cover;">
                        </div>
                    </div>
                    <div class="col-lg-4">
                        <div class="row g-5">
                ...
                <div class="col-lg-4 wow slideInUp" data-wow-delay="0.3s">
                    <div class="team-item bg-light rounded overflow-hidden">
                        <div class="team-img position-relative overflow-hidden">
                            <img class="img-fluid w-100" src="{{ asset('uploads/celebrities/' . $celebrity->image) }}" alt="">
