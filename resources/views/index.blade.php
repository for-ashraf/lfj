...
@section('title', 'Latest Fashion Jewellery') <!-- Define the title for the child page -->
...
<header class="jumbotron jumbotron-fluid">
    ...
    <p class="lead">Explore our wide selection of categories and find the perfect piece to add to your jewellery collection.</p>
